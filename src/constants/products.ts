...
export const PRODUCTS: Product[] = [
  ...
  },
  {
    ...
    name: 'Air Purifier',
    price: 199.99,
    description: 'HEPA air purifier with smart sensors and quiet operation for large rooms.',
  ...
  },
  {
    ...
    price: 24.99,
    description: 'Stylish reading glasses with blue light blocking and anti-glare coating.',
  ...
  },
  {
    ...
    price: 14.99,
    description: 'Adjustable portable phone stand compatible with all smartphone sizes.',
